...
def client_handler(client_socket):
    ...
    if command:
        ...
        while True:
            ...
            client_socket.send("<TuffyCat:#> ".encode('utf-8'))
...
def usage():
    ...
    print()
    print("Usage: netcat-cli.py -t target_host -p port")
    print(
    ...
    print()
    print("Examples: ")
    print("netcat-cli.py -t 192.168.0.1 -p 5555 -l -c")
    print("netcat-cli.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("netcat-cli.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCDEFGHI' | ./netcat-cli.py -t 192.168.11.12 -p 135")
    sys.exit(0)
